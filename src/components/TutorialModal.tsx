...
const STEPS: Step[] = [
  ...
  },
  {
    emoji: '🎁',
    title: '応答モードを使い分けよう',
    body: 'チャット右上の ⋮ から応答モードを切り替えられます。「軽量モード」と「古いモデル」はどのプランでも無制限に使えます（古いモデルは品質が lily-memo-2.0 version 相当のかわりにトークン消費0.1倍）。じっくり答えてほしいときは思考モードもどうぞ。',
    highlight: '軽量モード・古いモデルは無制限！',
  },
  {
    emoji: '📚',
    title: '学習トラッカー & 演習',
