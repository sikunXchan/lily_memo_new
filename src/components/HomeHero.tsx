...
export default function HomeHero({
  ...
  return (
    ...
    :global(.note-icon) { color: var(--fg-muted); flex-shrink: 0; }
    ...
    :global(.note-chevron) { color: var(--fg-faint); flex-shrink: 0; }
    ...
    :global(.tile-cta-icon) { color: var(--primary); flex-shrink: 0; }
    ...
    :global(.search-icon) { position: absolute; left: 13px; top: 50%; transform: translateY(-50%); color: var(--fg-faint); pointer-events: none; }
