...
import {
  ...
  Plus, ListTodo, Camera, X, PencilLine, Pen, MessageCircle,
} from 'lucide-react';
...
const BUBBLES: BubbleItem[] = [
  ...
  { key: 'diary',    label: 'DM',        tint: '#fde68a', size: 66,  pos: { left: '44%',  top: 232 }, floatDelay: 1.3, windAnim: 1, windDur: 6.1, isNew: true },
...
function BubbleIcon({ navKey, size }: { navKey: string; size: number }) {
  ...
  switch (navKey) {
    ...
    case 'diary':    return <MessageCircle {...p} />;
